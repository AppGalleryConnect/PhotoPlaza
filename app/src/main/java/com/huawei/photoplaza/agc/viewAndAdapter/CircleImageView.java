...
public class CircleImageView extends AppCompatImageView {
    ...
    private float mBorderWidth = dip2px(4);
    private int mBorderColor = getResources().getColor(R.color.colorMilkWite);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (rawBitmap != null) {
            ...
            maskFilter = new BlurMaskFilter(3, BlurMaskFilter.Blur.SOLID);
