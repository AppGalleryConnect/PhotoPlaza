...
public class CommentDBAction {
     ...
     */
    private final OnSnapshotListener<CommentTable> mSnapshotListener = (cloudDBZoneSnapshot, e) -> {
        if (e != null) {
        ...
        try {
            while (snapshotObjects.hasNext()) {
                ...
                CommentItem commentItem = new CommentItem(CommentTable.getUserID(),
                        CommentTable.getCommentID(),
                        CommentTable.getCommentText(),
                        CommentTable.getUserName(),
                        CommentTable.getCommentText());
    ...
    public void queryAllComments() {
        ...
        queryTask.addOnSuccessListener(snapshot -> processQueryResult(snapshot))
                .addOnFailureListener(e -> mCommentUiCallBack.onCommentErrorMessage("queryAllCommentError: " + e.getMessage()));
    }
    ...
    public void queryForDelete(String thisPhotoID) {
        ...
        queryTask.addOnSuccessListener(CloudDBZoneSnapshot -> {
            ...
            CloudDBZoneSnapshot.release();
            // After the array to be deleted is found, delete it
    ...
    public void deleteComments(List<CommentTable> CommentInfoList) {
        ...
        deleteTask.addOnSuccessListener(integer -> Log.e(TAG, "Delete Comment of Photo Success"))
                .addOnFailureListener(e -> {
